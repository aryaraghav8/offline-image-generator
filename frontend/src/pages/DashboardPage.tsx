        ...
        <section className="grid gap-6 lg:grid-cols-3">
          ...
          {/* <div className="card flex flex-col p-5">
            ...
            <button
              ...
              className="btn-plasma w-full justify-center gap-2"
              disabled={loading}
            >
              <Sparkles
                size={15}
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-6">
            ...
            0 ? (
              ...
              <div className="col-span-full rounded-lg border border-dark-700 p-8 text-center text-faint">
                No generations yet
              </div>
            )}
          </div>
